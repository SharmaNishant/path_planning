                       ...
                       visualization_msgs::Marker &endPoint)
{
    ...
    boundary.action             = obstacle.action             = startPoint.action             = endPoint.action             = visualization_msgs::Marker::ADD;
...
int main(int argc,char** argv)
{
    ...
    //defining Publisher
    ros::Publisher env_publisher = n.advertise<visualization_msgs::Marker>("path_planner_nc_bug",1);
    ...
    ncoReader.setSourceGoalPoints(argv[3], startPoint.pose.position, endPoint.pose.position);
